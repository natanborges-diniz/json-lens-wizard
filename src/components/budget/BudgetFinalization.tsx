...
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
Lente: ${(family as any).display_name || (family as any).name_display || family.name_original} (${family.supplier})
        ...
        <div className="grid md:grid-cols-2 gap-6">
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              <div>
                <h3 className="font-bold text-lg">{(family as any).display_name || (family as any).name_display || family.name_original}</h3>
